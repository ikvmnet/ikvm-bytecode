...
namespace IKVM.ByteCode.Reading
{
        ...
        where TReader : class
    {
        ...
        internal LazyReaderList(ClassReader declaringClass, TRecord[] records, uint minIndex = 0)
        {
        ...
        /// <returns></returns>
        public TReader this[ConstantHandle handle] => ResolveReader(handle.Index);
