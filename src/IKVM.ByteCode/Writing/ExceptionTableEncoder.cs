...
namespace IKVM.ByteCode.Writing
{
    ...
    public struct ExceptionTableEncoder
    {
        ...
        /// <summary>
        /// Adds an existing exception handler.
        /// </summary>
        /// <param name="record"></param>
        /// <returns></returns>
        public ExceptionTableEncoder Add(ExceptionHandlerRecord record)
        {
            return Exception(record.StartOffset, record.EndOffset, record.HandlerOffset, record.CatchType);
        }

        /// <summary>
        /// Adds existing exception handlers.
        /// </summary>
        /// <param name="records"></param>
        /// <returns></returns>
        public ExceptionTableEncoder AddMany(ReadOnlySpan<ExceptionHandlerRecord> records)
        {
        ...
        /// <param name="records"></param>
        /// <returns></returns>
        public ExceptionTableEncoder AddMany(IEnumerable<ExceptionHandlerRecord> records)
        {
            foreach (var i in records)
                Add(i);
