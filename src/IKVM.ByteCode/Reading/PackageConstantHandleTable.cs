...
namespace IKVM.ByteCode.Reading
{
    ...
    public readonly struct PackageConstantHandleTable : IReadOnlyList<PackageConstantHandle>
    {
        ...
        public void EncodeTo<TConstantView, TConstantPool>(TConstantView view, TConstantPool pool, ref PackageConstantTableEncoder encoder)
            ...
            where TConstantPool : class, IConstantPool
        {
            ...
            foreach (var i in this)
                encoder.PackageConstant(pool.Import(view, i));
        }
